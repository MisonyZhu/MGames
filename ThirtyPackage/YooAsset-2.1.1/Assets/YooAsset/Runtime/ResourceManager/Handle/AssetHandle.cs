...
namespace YooAsset
{
    public sealed class AssetHandle : HandleBase, IResourceHandler
    {
        ...
        event Action<IResourceHandler> IResourceHandler.Completed
        {
            add
            {
                if (IsValidWithWarning == false)
        ...
        InstantiateHandler IResourceHandler.InstantiateAsync()
        {
            throw new NotImplementedException();
        }

        InstantiateHandler IResourceHandler.InstantiateAsync(Transform parent)
        {
            throw new NotImplementedException();
        }

        InstantiateHandler IResourceHandler.InstantiateAsync(Transform parent, bool worldPositionStays)
        {
            throw new NotImplementedException();
        }

        InstantiateHandler IResourceHandler.InstantiateAsync(Vector3 position, Quaternion rotation)
        {
            throw new NotImplementedException();
        }

        InstantiateHandler IResourceHandler.InstantiateAsync(Vector3 position, Quaternion rotation, Transform parent)
        {
            throw new NotImplementedException();
        }

        GameObject IResourceHandler.InstantiateSyncInternal(bool setPositionAndRotation, Vector3 position, Quaternion rotation, Transform parent, bool worldPositionStays)
        {
            throw new NotImplementedException();
        }

        InstantiateHandler IResourceHandler.InstantiateAsyncInternal(bool setPositionAndRotation, Vector3 position, Quaternion rotation, Transform parent, bool worldPositionStays)
        {
            throw new NotImplementedException();
        }
    }
