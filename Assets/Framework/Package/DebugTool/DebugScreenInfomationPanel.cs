...
{
    public class DebugScreenInfomationPanel : DebugScrollPanel
    {
        protected override void DrawContent()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                DrawItem("Screen Width", string.Format("{0} px", Screen.width));
                DrawItem("Screen Height", string.Format("{0} px", Screen.height));
